...
â”œâ”€â”€ hexapod-projects.html             # Hexapod-family project hub
...
1. Copy `main-dashboard.html`, `hexapod-projects.html`, `hexabot-modules.html`, and the Hexabot module pages to your control station web server
